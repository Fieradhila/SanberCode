...
<body>
    ...
    <?php 
        ...
        */
        ...
        $rest = [];
        // Lakukan Looping di sini
        for($angka = 0; $angka < count($numbers); $angka++){
            $rest[] = $numbers[$angka] % 5;
        }
        ...
        */
        ...
        /*
        $data = [];
        for($list = 0; $list < count($items); $list++){
            $data = [
            "id" => $items[0],
            "name" => $items[1],
            "price" => $items[2],
        ...
        */
        echo "Asterix: ";
        echo "<br>";
        for ($asterix = 1; $asterix <= 5; $asterix++) { 
            for ($astor = 1; $astor <= $asterix; $astor++)
                echo "*";
                echo "<br>";
        }
